...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReceiptExpense.vendor'
        db.add_column('openbudgetapp_receiptexpense', 'vendor', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'ReceiptExpense.vat'
        db.add_column('openbudgetapp_receiptexpense', 'vat', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'ReceiptExpense.paidby'
        db.add_column('openbudgetapp_receiptexpense', 'paidby', self.gf('django.db.models.fields.CharField')(default='cash', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReceiptExpense.vendor'
        db.delete_column('openbudgetapp_receiptexpense', 'vendor')

        # Deleting field 'ReceiptExpense.vat'
        db.delete_column('openbudgetapp_receiptexpense', 'vat')

        # Deleting field 'ReceiptExpense.paidby'
        db.delete_column('openbudgetapp_receiptexpense', 'paidby')
