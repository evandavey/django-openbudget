...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.accountset'
        db.add_column('openbudgetapp_account', 'accountset', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['openbudgetapp.AccountSet']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.accountset'
        db.delete_column('openbudgetapp_account', 'accountset_id')
