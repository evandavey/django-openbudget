...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountBudget.note'
        db.add_column('openbudgetapp_accountbudget', 'note', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountBudget.note'
        db.delete_column('openbudgetapp_accountbudget', 'note')
