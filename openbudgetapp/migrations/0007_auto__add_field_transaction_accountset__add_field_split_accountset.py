...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.accountset'
        db.add_column('openbudgetapp_transaction', 'accountset', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['openbudgetapp.AccountSet']), keep_default=False)

        # Adding field 'Split.accountset'
        db.add_column('openbudgetapp_split', 'accountset', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['openbudgetapp.AccountSet']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Transaction.accountset'
        db.delete_column('openbudgetapp_transaction', 'accountset_id')

        # Deleting field 'Split.accountset'
        db.delete_column('openbudgetapp_split', 'accountset_id')
