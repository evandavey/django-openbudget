...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountBudget.estimated'
        db.add_column('openbudgetapp_accountbudget', 'estimated', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountBudget.estimated'
        db.delete_column('openbudgetapp_accountbudget', 'estimated')
