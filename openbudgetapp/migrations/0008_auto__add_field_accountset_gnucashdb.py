...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountSet.gnucashdb'
        db.add_column('openbudgetapp_accountset', 'gnucashdb', self.gf('django.db.models.fields.FilePathField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountSet.gnucashdb'
        db.delete_column('openbudgetapp_accountset', 'gnucashdb')
    ...
    models = {
        ...
        'openbudgetapp.accountset': {
            ...
            'gnucashdb': ('django.db.models.fields.FilePathField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
