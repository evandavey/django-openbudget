...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountExtra.investment_category'
        db.add_column('openbudgetapp_accountextra', 'investment_category', self.gf('django.db.models.fields.CharField')(default='NONE', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountExtra.investment_category'
        db.delete_column('openbudgetapp_accountextra', 'investment_category')
    ...
    models = {
        ...
        'openbudgetapp.accountextra': {
            ...
            'investment_category': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
