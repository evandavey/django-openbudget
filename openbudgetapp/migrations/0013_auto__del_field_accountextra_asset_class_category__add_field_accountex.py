...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountExtra.asset_class'
        db.add_column('openbudgetapp_accountextra', 'asset_class', self.gf('django.db.models.fields.CharField')(default='NONE', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AccountExtra.asset_class'
        db.delete_column('openbudgetapp_accountextra', 'asset_class')
